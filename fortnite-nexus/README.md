...
FortniteNexus 
FortniteNexus is a work in progress, dynamic and responsive web application built for the Fortnite community. It allows players to look up their in-game statistics, compare their performance against others, and browse the current item shop in real-time.
